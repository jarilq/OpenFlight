...
inline SGPropertyNode *fgGetNode (char *partA, const char *partB, bool create = false) //changed from original file to allow concatenation
{
	strcat(partA,partB);
...
inline SGPropertyNode *fgGetNode (char *partA, const char *partB, int index, bool create = false)//changed from original file to allow concatenation
{
	strcat(partA,partB);
	const char *path = partA;
